...
export const CarList = () => {
    ...
    const formatMoeda = (value: number) => {
      const moeda = value.toLocaleString("pt-br", {
        style: "currency",
        currency: "BRL",
      });
      return `${moeda}`;
          ...
          <div className="list">
            {list.map((car, index) => (
              <div key={index} className="carItem">
                ...
                <div className="column km">{formatMoeda(car.km)} Km</div>
                <div className="column price">{formatMoeda(car.price)}</div>
